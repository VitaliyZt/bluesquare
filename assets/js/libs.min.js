...
*/
var layoutEngine=function(){var e,t=document.documentElement,n=t.style,r=" vendor-",i="edge",o="ie",a="khtml",s="mozilla",u="opera",l="webkit",c=" browser-",f="android",p="chrome",d="safari",h=d+"-ios",g="wiiu",v=r;if("msScrollLimit"in n||"behavior"in n)"msTextSizeAdjust"in n&&!("msFlex"in n)?(v+=i,e={vendor:i}):(v+=o+r+o,e={vendor:o},"msImeAlign"in n?(v+="-11",e.version=11):"msUserSelect"in n?(v+="-10",e.version=10):"fill"in n?(v+="-9",e.version=9):"widows"in n?(v+="-8",e.version=8):(v+="-7",e.version=7));else if("WebkitAppearance"in n){v+=l;var m=navigator.userAgent;e={vendor:l},window.chrome||m.indexOf("OPR")>=0||m.indexOf("wv")>=0?(v+=c+p,e.browser=p):"webkitDashboardRegion"in n?(v+=c+d,e.browser=d):"webkitOverflowScrolling"in n?(v+=c+h,e.browser=h):m.indexOf("Android")>=0?(v+=c+f,e.browser=f):window.wiiu&&(v+=c+g,e.browser=g)}else if("MozAppearance"in n)v+=s,e={vendor:s};else if("OLink"in n||window.opera)v+=u,e={vendor:u},"OMiniFold"in n&&(v+="-mini",e.browser="mini");else{if(!("KhtmlUserInput"in n))return!1;v+=a,e={vendor:a}}return t.className+=v,e}();